            ...
            <div class="lg:w-2/3">
                <?php foreach ($data['data'] as $sol) : ?>
                    <div x-show="activeTab === '<?php echo esc_js($sol['id']); ?>'"
                        ...
                        <div class="bg-white mb-10 rounded-3xl p-8 lg:p-12 shadow-xl border border-gray-100 h-full flex flex-col transition-all duration-300">

                                <h3 class="text-xl lg:text-3xl font-black text-[#1A2B3C] mb-6 font-heading leading-snug transition-colors">
                                    ...
                                    <?php if ($sol['diagramType'] === 'three-party') : ?>
                                        <div class="relative w-full max-w-75 aspect-square">
                                            ...
                                            <div class="absolute top-0 left-1/2 -translate-x-1/2 w-20 h-20 bg-white rounded-full shadow-lg border border-gray-100 flex flex-col items-center justify-center z-10">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-[#FFD700] mb-1">
                                            ...
                                            <div class="absolute bottom-4 left-0 w-20 h-20 bg-white rounded-full shadow-lg border border-gray-100 flex flex-col items-center justify-center z-10">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-blue-500 mb-1">
                                            ...
                                            <div class="absolute bottom-4 right-0 w-20 h-20 bg-white rounded-full shadow-lg border border-gray-100 flex flex-col items-center justify-center z-10">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-[#228B22] mb-1">
                                ...
                                <?php if ($sol['diagramType'] === 'three-party') : ?>
                                    <div class="relative w-full max-w-60 aspect-square">
                                        ...
                                        <div class="absolute top-0 left-1/2 -translate-x-1/2 w-14 h-14 bg-white rounded-full shadow-md border border-gray-100 flex flex-col items-center justify-center z-10">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-[#FFD700] mb-0.5">
                                                <path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z" />
                                            </svg>
                                        ...
                                        <div class="absolute bottom-2 left-0 w-14 h-14 bg-white rounded-full shadow-md border border-gray-100 flex flex-col items-center justify-center z-10">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-blue-500 mb-0.5">
                                                <path d="M22 10v6M2 10l10-5 10 5-10 5z" />
                                                <path d="M6 12v5c3 3 9 3 12 0v-5" />
                                            </svg>
                                        ...
                                        <div class="absolute bottom-2 right-0 w-14 h-14 bg-white rounded-full shadow-md border border-gray-100 flex flex-col items-center justify-center z-10">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-[#228B22] mb-0.5">
                                                <line x1="3" y1="21" x2="21" y2="21" />
                                                <line x1="3" y1="7" x2="21" y2="7" />
                                                <path d="M9 21V11" />
                                                <path d="M15 21V11" />
