                ...
                <div class="grid lg:grid-cols-4 gap-12 mb-20">
                    ...
                    <div class="space-y-6">
                        ...
                        <ul class="inline-flex space-x-3 text-sm text-gray-300">
                            ...
                            <?php endif; ?>
                            <?php if (!empty($footer_social_phone) && !empty($footer_social_phone_href)) : ?>
                                <li>
                                    <a href="tel:<?php echo esc_attr($footer_social_phone_href); ?>" class="flex items-center justify-center w-10 h-10 rounded-full bg-white/10 hover:bg-white/20 transition-colors" aria-label="Phone">
                                        <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" role="img" aria-hidden="true">
                        ...
                        <div class="relative z-10">
                            ...
                            <?php if (!empty($address_1)) : ?>
                                <li class="flex items-start">
                                    <svg class="w-5 h-5 text-[#228B22] shrink-0 mr-3 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" role="img" aria-hidden="true">
                            ...
                            <?php if (!empty($email)) : ?>
                                <li class="flex items-center">
                                    <svg class="w-5 h-5 text-[#228B22] shrink-0 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" role="img" aria-hidden="true">
                            ...
                            <?php if (!empty($phone)) : ?>
                                <li>
                                    <a href="<?php echo esc_url('tel:' . preg_replace('/[^0-9+]/', '', $phone)); ?>" class="inline-flex items-center gap-3 hover:text-white transition-colors">
                                        <svg class="w-5 h-5 text-[#228B22] shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" role="img" aria-hidden="true">
